...
// receive two para,s and returns one
...
// sum can receive one or many params for example sum(1,2) or sum(1,2,3,4)
...
func main() {
	...
	// the address of number is passes to function that change it value
